...
# Your Excel uses "Number", not "Current"
required_columns = ["Category", "Indicator", "Reporting Agency", "State", "County", "Number"]
missing = [c for c in required_columns if c not in df.columns]
if missing:
    raise ValueError(f"Missing required columns in Excel: {missing}. Available columns: {list(df.columns)}")

# Your Excel category is FoodSecurity
